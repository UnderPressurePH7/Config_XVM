 ...
 */
{
  ...
  "def": {
    ...
    "damageText": {
      ...
      //Not_Souls"damageMessage": "{{dmg}}",
      "damageMessage": "<img src='xvm://res/icons/spirit.png'>\n\n{{dmg}}",
      ...
      //Not_Souls"blowupMessage": "{{l10n:blownUp}}\n{{dmg}}"
      "blowupMessage": "<img src='xvm://res/icons/spirit_bk.png'>\n\n{{dmg}}"
    },
    // Floating damage values.
    // Всплывающий урон.
    "damageTextEnemy": {
      ...
      // Текст при обычном уроне (см. описание макросов в macros.txt).
      //Not_Souls"damageMessage": "{{dmg}}",
      "damageMessage": "<img src='xvm://res/icons/spirit_enemy.png'>\n\n{{dmg}}",
      // Text for ammo rack explosion (see description of macros in the macros.txt).
      // Текст при взрыве боеукладки (см. описание макросов в macros.txt).
      //Not_Souls"blowupMessage": "{{l10n:blownUp}}\n{{dmg}}"
      "blowupMessage": "<img src='xvm://res/icons/spirit_bk_enemy.png'>\n\n{{dmg}}"
    }
  },
  // Settings for allies.
